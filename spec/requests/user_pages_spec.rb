...
describe 'User pages' do
  ...
  describe 'profile page' do
    ...
    describe 'follow/unfollow buttons' do
      ...
      describe 'following a user' do
        ...
        it 'should increment the followers count for the other user' do
      ...
      describe 'unfollowing a user' do
        ...
        it 'should decrement the followers count for the other user' do
  ...
  describe 'existing user accessing sign-up pages' do
    let(:user) { FactoryGirl.create(:user) }
    ...
    describe 'submitting a POST request to the Users#create action' do
      let(:params) do
        {user: {name: 'a', email: 'a@a.com', password:'p', password_confirmation: 'p'}}
      end
